...
export default function AccountPage() {
  ...
  const joinDate = "created_at" in user
    ? new Date((user as { created_at: string }).created_at).toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
      })
    : null;
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      {/* Hero Banner */}
      <div className={`relative bg-gradient-to-br ${getGradient(user.name)} border-b`}>
